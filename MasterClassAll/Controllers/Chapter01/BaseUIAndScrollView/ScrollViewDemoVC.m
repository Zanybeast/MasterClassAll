...
- (void)viewDidLoad {
    ...
    NSLog(@"scrollview content size width: %f, height: %f", self.scrollView.contentSize.width, self.scrollView.contentSize.height);
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    NSLog(@"scrollView content offset x: %f, y: %f",
...
- (void)scrollViewDidZoom:(UIScrollView *)scrollView {
    NSLog(@"Scroll View Did Zoom: %f", scrollView.zoomScale);
}
